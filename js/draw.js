...
// 画坐标图
const draw = function(tableData, allProcess, allTime) {
...
const drawAxis = function(allProcess, allTime) {
...
// 填充数据的函数
const drawData = function(tableData, allProcess, w, h) {
